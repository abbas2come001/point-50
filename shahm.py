...
async def _(event):
    ...
    for i in range(100):
        ...
        if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
            ...
            await shahm1.send_message(event.chat_id, f"**تم الانتهاء من التجميع | SY**")
    ...
    await shahm1.send_message(event.chat_id, "**تم الانتهاء من التجميع | SY**")
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joino = await shahm1(JoinChannelRequest('zd_e6'))
